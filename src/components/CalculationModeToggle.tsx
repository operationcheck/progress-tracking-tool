...
export const CalculationModeToggle = ({
  mode,
  onModeChange,
  ...
  return (
    <div class="max-w-6xl mx-auto bg-white rounded-lg border border-slate-300 p-6 mb-6">
            ...
            <div class="flex items-center space-x-3">
              <div
                class={`w-4 h-4 rounded-full border-2 flex items-center justify-center ${
                  mode === option.value ? 'border-blue-500' : 'border-slate-300'
                }`}
              >
                {mode === option.value && (
      ...
      <div class="mt-4 p-4 bg-slate-50 border border-slate-200 rounded-md">
        <p class="text-sm text-slate-700">
          ...
          {mode === 'completion' ? 'Completion Based' : 'Weighted Average'}
        </p>
